...
if __name__ == '__main__':
    out_paths = run_advector_3D(
        output_directory=str(examples_root / 'outputfiles/ECCO_2015_3D' / Path(sourcefile).stem),
        sourcefile_path=sourcefile,
        configfile_path=str(examples_root / 'configfiles/config.nc'),
        u_water_path=str(examples_root / 'ECCO/ECCO_interp/U_2015*.nc'),
        v_water_path=str(examples_root / 'ECCO/ECCO_interp/V_2015*.nc'),
        w_water_path=str(examples_root / 'ECCO/ECCO_interp/W_2015*.nc'),
        ...
        seawater_density_path=str(examples_root / 'ECCO/ECCO_interp/RHO_2015.nc'),
