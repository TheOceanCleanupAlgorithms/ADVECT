...
class AdvectionScheme3D(Enum):
    """matching definitions in src/kernels/kernel_3d.cl"""
    eulerian3d = 0
...
class Kernel3D:
    ...
    def __init__(self,
                 ...
                 advection_scheme: AdvectionScheme3D, eddy_diffusivity: float, windage_coeff: Optional[float],
